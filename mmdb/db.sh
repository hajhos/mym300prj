...
# User fuer Remote Zugriff einrichten - aber nur fuer Host web 192.168.2.201
mysql -uroot -pS3cr3tp4ssw0rd <<%EOF%
	CREATE USER 'root'@'192.168.2.201' IDENTIFIED BY 'admin';
	GRANT ALL PRIVILEGES ON *.* TO 'root'@'192.168.2.201';
	FLUSH PRIVILEGES;
%EOF%
